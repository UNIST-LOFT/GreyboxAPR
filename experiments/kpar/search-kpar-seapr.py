...
def run(project):
    ...
    result=subprocess.run(['python3',f'{new_cur_dir}/SimAPR/simapr.py','-o',f'result/{project}-seapr','-m','seapr','--ignore-compile-error','--use-pattern','--instr-cp','/root/project/greybox-APR/build/libs/JPatchInst.jar',
