...
def run(project):
   for i in range(10):
      ...
      # result=subprocess.run(['python3','search-srepair-ablation-greybox.py',project,'vertical','branch',str(seeds.SEEDS[i]),str(i)],
      ...
      #    result=subprocess.run(['python3','search-srepair-ablation-greybox.py',project,'vertical','field',str(seeds.SEEDS[i]),str(i)],
      #                         stdout=subprocess.PIPE,stderr=subprocess.STDOUT)
      ...
      #    result=subprocess.run(['python3','search-srepair-ablation-greybox.py',project,'vertical','both',str(seeds.SEEDS[i]),str(i)],
      #                         stdout=subprocess.PIPE,stderr=subprocess.STDOUT)
