...
def run(project,seed):
    ...
    result=subprocess.run(['python3',f'{new_cur_dir}/SimAPR/simapr.py','-o',f'result/{project}-simapr','-m','guided','--seed',f'{seed}','--use-exp-alpha','--instr-cp','/root/project/greybox-APR/build/libs/JPatchInst.jar',
