...
def run(project):
   for i in range(10):
      result_path=f'/root/project/GreyboxAPR/experiments/avatar/result/{project}-greybox-fieldonly-{i}'
      field_path=f'/root/project/GreyboxAPR/experiments/avatar/result/field/{project}'
      ...
      result_path=f'/root/project/GreyboxAPR/experiments/avatar/result/{project}-greyboxfd-{i}'
