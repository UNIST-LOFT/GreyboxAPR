...
def run(project):
    ...
    result=subprocess.run(['python3','search-selfapr-orig.py',project],stdout=subprocess.PIPE,stderr=subprocess.STDOUT)
    ...
    for i in range(10):
        ...
        result=subprocess.run(['python3','search-selfapr-casino.py',project,str(seeds.SEEDS[i]),str(i)],
        ...
        result=subprocess.run(['python3','search-selfapr-greybox.py',project,str(seeds.SEEDS[i]),str(i)],
                                stdout=subprocess.PIPE,stderr=subprocess.STDOUT)
        ...
        result=subprocess.run(['python3','search-selfapr-greyboxfd.py',project,str(seeds.SEEDS[i]),str(i)],
                                stdout=subprocess.PIPE,stderr=subprocess.STDOUT)
