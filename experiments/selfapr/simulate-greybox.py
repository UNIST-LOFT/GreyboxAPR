...
def run(project):
   for i in range(10):
      result_path=f'/root/project/GreyboxAPR/experiments/selfapr/result/{project}-greybox-fieldonly-{i}'
      field_path=f'/root/project/GreyboxAPR/experiments/selfapr/result/field/{project}'
      ...
      result_path=f'/root/project/GreyboxAPR/experiments/selfapr/result/{project}-greyboxfd-{i}'
